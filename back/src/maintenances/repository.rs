...
"#,
    ...
    for item in &payload.timeline {
        ...
        sqlx::query(
            r#"
INSERT INTO maintenance_timeline (id, maintenance_id, at_utc, sort_order, last_modified_by_user_id, created_by_user_id)
VALUES ($1, $2, $3, $4, $5, $6)
...
pub async fn create_timeline_entry(
    ...
    sqlx::query(
        "INSERT INTO maintenance_timeline (id, maintenance_id, at_utc, sort_order, last_modified_by_user_id, created_by_user_id) VALUES ($1, $2, $3, $4, $5, $6)",
    )
    .bind(timeline_id)
    .bind(maintenance_id)
    .bind(at_utc)
