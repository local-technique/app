...
const router = createRouter({
  ...
  routes: [
    ...
    { path: "/events", component: EventsPage, meta: { requiresAuth: true, requiredRoles: ["ADMIN", "CO_OWNER", "CO_OWNERSHIP_BOARD", "CO_OWNERSHIP_BOARD_OPS"] } },
    { path: "/events/new", component: EventFormPage, meta: { requiresAuth: true, requiredRoles: ["ADMIN", "CO_OWNERSHIP_BOARD", "CO_OWNERSHIP_BOARD_OPS"] } },
    { path: "/events/:id", component: EventDetailPage, meta: { requiresAuth: true, requiredRoles: ["ADMIN", "CO_OWNER", "CO_OWNERSHIP_BOARD", "CO_OWNERSHIP_BOARD_OPS"] } },
    { path: "/events/:id/edit", component: EventFormPage, meta: { requiresAuth: true, requiredRoles: ["ADMIN", "CO_OWNERSHIP_BOARD", "CO_OWNERSHIP_BOARD_OPS"] } },
    { path: "/incidents", component: IncidentsPage, meta: { requiresAuth: true, requiredRoles: ["ADMIN", "CO_OWNER", "CO_OWNERSHIP_BOARD", "CO_OWNERSHIP_BOARD_OPS"] } },
    { path: "/incidents/new", component: IncidentFormPage, meta: { requiresAuth: true, requiredRoles: ["ADMIN", "CO_OWNERSHIP_BOARD", "CO_OWNERSHIP_BOARD_OPS"] } },
    { path: "/incidents/:id", component: IncidentDetailPage, meta: { requiresAuth: true, requiredRoles: ["ADMIN", "CO_OWNER", "CO_OWNERSHIP_BOARD", "CO_OWNERSHIP_BOARD_OPS"] } },
    { path: "/incidents/:id/edit", component: IncidentFormPage, meta: { requiresAuth: true, requiredRoles: ["ADMIN", "CO_OWNERSHIP_BOARD", "CO_OWNERSHIP_BOARD_OPS"] } },
    { path: "/projects", component: ProjectsPage, meta: { requiresAuth: true, requiredRoles: ["ADMIN", "CO_OWNER", "CO_OWNERSHIP_BOARD", "CO_OWNERSHIP_BOARD_OPS"] } },
    { path: "/projects/new", component: ProjectFormPage, meta: { requiresAuth: true, requiredRoles: ["ADMIN", "CO_OWNERSHIP_BOARD", "CO_OWNERSHIP_BOARD_OPS"] } },
    { path: "/projects/:id", component: ProjectDetailPage, meta: { requiresAuth: true, requiredRoles: ["ADMIN", "CO_OWNER", "CO_OWNERSHIP_BOARD", "CO_OWNERSHIP_BOARD_OPS"] } },
    { path: "/projects/:id/edit", component: ProjectFormPage, meta: { requiresAuth: true, requiredRoles: ["ADMIN", "CO_OWNERSHIP_BOARD", "CO_OWNERSHIP_BOARD_OPS"] } },
    { path: "/admin/users", component: AdminUsersPage, meta: { requiresAuth: true, requiredRole: "ADMIN" } },
    { path: "/admin/categories", component: AdminCategoriesPage, meta: { requiresAuth: true, requiredRoles: ["ADMIN", "CO_OWNERSHIP_BOARD_OPS"] } },
