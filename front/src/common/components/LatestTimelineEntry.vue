...
defineProps<{ entry: LatestEntry }>();
</script>

<template>
  <aside class="latest-timeline-entry latest-timeline-entry-stretched">
    <p class="timeline-meta" v-if="!entry.isPending">{{ entry.atLabel }}</p>
