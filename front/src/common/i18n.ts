...
export const messages = {
  en: {
    ...
    labels: {
      ...
      cancel: "Cancel",
      close: "Close",
      markdownHelpTitle: "Markdown formatting",
      markdownHelpText: "This field supports Markdown for formatting text. You can use bold, italic, lists, links, and more.",
      markdownHelpLink: "Learn more about Markdown",
      saveRolesFailed: "Roles could not be saved.",
      saveUserFailed: "User could not be saved.",
      ...
      datesToBeConfirmed: "Dates to be confirmed",
      startUtc: "Start",
      endUtc: "End",
      title: "Title",
      ...
      warning: "Warning",
      displayWarningCheckbox: "Warn residents of a service disruption",
      warningPlaceholder: "e.g. 19 June: no hot water between 9h and 18h, or parking lot unavailable during August",
      location: "Location",
      details: "Details",
      ...
      statusPlaceholderOngoing: "Additional status information",
      statusPlaceholderBlocking: "Describe what is blocking",
  ...
  fr: {
    ...
    labels: {
      ...
      cancel: "Annuler",
      close: "Fermer",
      markdownHelpTitle: "Formatage Markdown",
      markdownHelpText: "Ce champ accepte le Markdown pour formater le texte. Vous pouvez utiliser du gras, italique, listes, liens, et plus.",
      markdownHelpLink: "En savoir plus sur Markdown",
      saveRolesFailed: "Les rôles n'ont pas pu être enregistrés.",
      saveUserFailed: "L'utilisateur n'a pas pu être enregistré.",
      firstName: "Prénom",
      lastName: "Nom",
      editUserTitle: "Modifier l'utilisateur {email}",
      never: "Jamais",
      ...
      datesToBeConfirmed: "Dates à confirmer",
      startUtc: "Début",
      endUtc: "Fin",
      title: "Titre",
      description: "Description",
      ...
      warning: "Alerte",
      displayWarningCheckbox: "Avertir les résidents d'une coupure de service",
      warningPlaceholder: "p. ex. 19 juin : pas d'eau chaude entre 9h et 18h, ou parking indisponible durant août",
      location: "Lieu",
      details: "Détails",
      ...
      statusPlaceholderOngoing: "Informations complémentaires sur le statut",
      statusPlaceholderBlocking: "Décrivez ce qui bloque",
      locationPlaceholder: "Détails du lieu",
    },
    controls: {
      language: "Langue",
      theme: "Thème",
